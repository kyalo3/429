...
export default function RecipientRegistrationForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Step 3: Create the recipient profile
      const recipientResponse = await fetch(
        "http://localhost:8000/recipients/",
        {
          ...
          body: JSON.stringify({
            ...
            house_hold_size: formData.house_hold_size,
            house_hold_members: formData.house_hold_members,
      ...
      if (!recipientResponse.ok) {
        throw new Error("Recipient profile creation failed");
      }
